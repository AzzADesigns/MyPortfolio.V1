...
export const ExperienceGrid = ({ hoveredNumber, setHoveredNumber, setSelectedProject, isAnimated }: ExperienceGridProps) => {
    ...
    return (
        <>
            ...
            <div className="relative w-full max-w-[1200px] mt-18 md:mt-0 xl:max-w-[1400px] mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-y-[18vh] xs:gap-y-[20vh] md:gap-y-[22vh] lg:gap-24 justify-items-center">
