...
export const ActualPojects = () => {
    ...
    return (
        <Card extraClass="w-full transition-all p-np mt-5 xl:w-73 2xl:w-83 backdrop-blur-sm bg-background/20 xl:bg-foreground rounded-2xl xl:rounded-t-3xl p-4">
