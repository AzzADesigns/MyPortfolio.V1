...
export default function Home() {
    ...
    return (
        <div className="flex flex-col overflow-x-hidden justify-center items-center  new2xl:w-[1510px] 3xl:w-[1713px]  max-w-[1713px] min-h-screen bg-background text-textColor font-[family-name:var(--font-geist-sans)] selection">
            ...
            <div className="flex flex-col h-full items-center xl:items-start w-[500px] md:w-[85%] xl:mr-40  2xl:w-[800px] xl:w-[47%]">
                <section className="fixed w-full z-50 left-0 xl:left-[69.5%] new2xl:left-[1100px] 3xl:left-[1200px]  xl:w-70 xl:top-10">
                    <Them_Trans />
